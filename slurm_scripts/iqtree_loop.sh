...
do
	...
	cp /Users/caitlincherryh/Documents/Repositories/metazoan-mixtures/iqtree_format.sh iqtree_run_$i.sh
...
ls > /Users/caitlincherryh/Documents/C3_TreeMixtures_Sponges/04_output/iqtree_runs.sh

# Add the prefix "sbatch " to each line (to call all  432 jobs at once)
sed -i'.bak' 's/^/sbatch /' /Users/caitlincherryh/Documents/C3_TreeMixtures_Sponges/04_output/iqtree_runs.sh
